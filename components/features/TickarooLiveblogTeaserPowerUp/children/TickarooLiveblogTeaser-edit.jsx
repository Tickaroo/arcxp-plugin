...
const TickarooLiveblogTeaserEdit = () => {
  ...
  useEffect(() => {
    ...
    if(decodedParameters.config?.liveblogUrl) setLiveblogUrl(decodedParameters.config.liveblogUrl);
  }, [])
...
#form-container button:hover {
  background: rgb(9 22 120);
    ...
    <div id="form-container">
      ...
      />
      <p id="form-hint">Leave blank to let the teaser resolve the link itself — from the liveblog&apos;s canonical URL with SEO prefetch enabled, from analytics data without it.</p>
...
export default TickarooLiveblogTeaserEdit;
